...
def build():
    ...
    for name in ("Config", "Validation", "Favorites", "HubState", "EmoteDetails", "HubLayout"):
...
def main():
    ...
    if args.check:
        ...
        print("Modelo XML OK: las 8 fuentes coinciden; servidor desactivado para importación segura.")
    else:
